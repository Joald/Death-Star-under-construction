...
function load(){
	...
	pics[12].src='4096.png';
	pics[13].src='8192.png';
	pics[14].src='16384.jpg';
}
var score=0;
var lastscore=0; 
var ifended=false;
...
function undo()
{
	document.getElementById("title").innerHTML="Gondorian Army";
	score-=lastscore;
	for (var i=0;i<4;i++)
	{
		for (var j=0;j<4;j++)
