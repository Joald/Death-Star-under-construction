...
<link rel="shortcut icon" href="http://joald.w.staszic.waw.pl/favicon.ico" />
...
function load(){
	...
	pics[0].src='http://joald.w.staszic.waw.pl/gondor/empty.png';
	pics[1].src='http://joald.w.staszic.waw.pl/muchdoge/2.gif';
	pics[2].src='http://joald.w.staszic.waw.pl/muchdoge/4.gif';
	pics[3].src='http://joald.w.staszic.waw.pl/muchdoge/8.gif';
	pics[4].src='http://joald.w.staszic.waw.pl/muchdoge/16.gif';
	pics[5].src='http://joald.w.staszic.waw.pl/muchdoge/32.gif';
	pics[6].src='http://joald.w.staszic.waw.pl/muchdoge/64.gif';
	pics[7].src='http://joald.w.staszic.waw.pl/muchdoge/128.gif';
	pics[8].src='http://joald.w.staszic.waw.pl/muchdoge/256.gif';
	pics[9].src='http://joald.w.staszic.waw.pl/muchdoge/512.gif';
	pics[10].src='http://joald.w.staszic.waw.pl/muchdoge/1024.gif';
	pics[11].src='http://joald.w.staszic.waw.pl/muchdoge/2048.gif';
	pics[12].src='http://joald.w.staszic.waw.pl/muchdoge/4096.gif';
	pics[13].src='http://joald.w.staszic.waw.pl/muchdoge/8192.gif';
	pics[14].src='http://joald.w.staszic.waw.pl/muchdoge/16384.gif';
}
var score=0;
var lastscore=0; 
var ifended=false;
...
<h1  id="title">much doge numbere</h1>
...
<button class="buthany" id="left" type="button" onclick="lk()"></button>
<button class="buthany" id="right" type="button" onclick="rk()"></button>
...
$p=fopen("http://joald.w.staszic.waw.pl/skrypty/highscore.txt","r");
$a=fread($p,100);
fclose($p);
$p=fopen("http://joald.w.staszic.waw.pl/skrypty/highplaya.txt","r");
$b=fread($p,100);
fclose($p);
...
var tlo=new Image();
tlo.src='http://joald.w.staszic.waw.pl/gondor/tlo.png';
function randspawn(){
	var i=0;
	var j=0;
...
function undo()
{
	document.getElementById("title").innerHTML="muchdogeian Army";
	score-=lastscore;
	for (var i=0;i<4;i++)
	{
		for (var j=0;j<4;j++)
