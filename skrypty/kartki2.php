...
<button class="buthany" id="next" type="button" onclick="kartki3()">Następna kartka</button>
<button class="buthany" id="previous" type="button" onclick="kartki1()">Poprzednia kartka</button>
<br>
...
<div class="cards">
<p class="ctext">FLOTA IMPERIUM PRZESYŁA <br>PRZYKŁADOWY TEKST ŻYCZEŃ</p>
</div>
<br>
<br>
<br>
