...
<button class="buthany" id="next" type="button" onclick="kartki1()">Następna kartka</button>
<button class="buthany" id="previous" type="button" onclick="kartki2()">Poprzednia kartka</button>
...
<div class="cardt">
<p class="ctext">JABBA PRZESYŁA PRZYKŁADOWY TEKST ŻYCZEŃ</p>
</div>
<br>
<br>
<br>
